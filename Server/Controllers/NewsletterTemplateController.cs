...
namespace Chloe.Server.Controllers
{
    ...
    public class NewsletterTemplateController : ApiController
    {
        ...
        [Route("add")]
        [HttpPost]
        public IHttpActionResult Add(NewsletterTemplateAddOrUpdateRequestDto dto) { return Ok(this.service.AddOrUpdate(dto)); }

        [Route("update")]
        [HttpPut]
        public IHttpActionResult Update(NewsletterTemplateAddOrUpdateRequestDto dto) { return Ok(this.service.AddOrUpdate(dto)); }
        ...
        protected readonly INewsletterTemplateService service;
